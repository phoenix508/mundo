  ...
  return (
    <div className="min-h-screen bg-[#f5f7ff]">
      ...
      <motion.div 
        ...
        className="fixed top-6 left-1/2 transform -translate-x-1/2 bg-white/90 backdrop-blur-lg z-50 shadow-lg px-8 py-4 rounded-full flex items-center space-x-8"
      >
        ...
        <div className="flex space-x-6">
          ...
          <a href="#destinations" className="text-gray-700 hover:text-blue-500 transition">Destinations</a>
        ...
        <a
          ...
          className="bg-blue-600 text-white px-5 py-2 rounded-full shadow-md flex items-center"
        >
      ...
      {/* Hero Section */}
      <div 
        className="relative h-[700px] bg-cover bg-center flex items-center justify-center text-white text-center px-6"
        style={{
      ...
      >
        ...
        >
          ...
          <motion.a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-8 inline-flex items-center px-6 py-3 bg-red-600 text-white rounded-full shadow-lg text-lg hover:bg-red-700 transition"
      ...
      <div id="destinations" className="py-24 bg-[#eef1ff]">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 mt-2">Discover the most sought-after destinations.</p>
        </div>
